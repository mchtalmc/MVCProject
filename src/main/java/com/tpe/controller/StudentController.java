...
public class StudentController {
    ...
    public String sendStudentForm(@ModelAttribute("student")Student student){
        //views;da belirledigim jsp dosyasinda("student")
        // model icerisinde olan form'da alinan bilgileri Student objesine kaydedilmesini istiyorum 32.satirda
        return "studentForm";
    }
    ...
    public String saveStudent(@Valid @ModelAttribute Student student,BindingResult bindingResult){
        ...
        //Students request'ine yonlendirmek icin "redirect" kullaniyorum.
    }
